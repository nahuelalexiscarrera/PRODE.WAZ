...
// Ruta PÚBLICA (fuera de /app): accesible sin sesión, se linkea desde el registro.
export default async function PrivacidadPublicPage() {
  ...
  return (
    ...
    >
      <ScreenHeader title="Política de privacidad" backHref="/login" />
      ...
      <div className="flex flex-col gap-6 px-4 pt-4 text-body-sm text-text leading-relaxed">
        <section className="flex flex-col gap-2">
          ...
          <p className="text-text-muted">
            ...
            nombre para mostrar, predicciones realizadas, publicaciones en el muro social, y
            preferencias de notificación. No recopilamos datos de pago ni información financiera de
            ningún tipo.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-2">
          ...
          <p className="text-text-muted">
            Los datos se utilizan exclusivamente para: mostrar tu posición en el ranking, calcular
            tus puntos, enviarte notificaciones según tus preferencias, y mejorar la experiencia de
            la aplicación. No vendemos ni compartimos datos con terceros fuera de {brandName}.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-2">
          ...
          <p className="text-text-muted">
            ...
            configuración en cualquier momento desde Configuración. El ranking siempre es público
        ...
        <section className="flex flex-col gap-2">
          ...
          <p className="text-text-muted">
            ...
            visibles para los demás socios. Al eliminar un post, la imagen asociada puede permanecer
            en el servidor por un período de hasta 30 días.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-2">
          ...
          <p className="text-text-muted">
            ...
            tu cuenta y datos asociados en cualquier momento contactando a {brandName}. El historial
            de predicciones puede conservarse de forma anónima para estadísticas.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-2">
          ...
          <p className="text-text-muted">
            Utilizamos Supabase con Row Level Security (RLS) para garantizar que cada usuario solo
            accede a sus propios datos privados. Las contraseñas nunca se almacenan en texto plano.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-2">
          ...
          <p className="text-text-muted">
            ...
            recepción de {brandName} o por los canales de comunicación del club.
          </p>
        </section>
